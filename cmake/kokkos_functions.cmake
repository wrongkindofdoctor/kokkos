...
MACRO(kokkos_create_imported_tpl NAME)
  ...
  IF (TPL_INTERFACE)
    ADD_LIBRARY(Kokkos::${NAME} INTERFACE IMPORTED)
  ELSE()
    ADD_LIBRARY(Kokkos::${NAME} UNKNOWN IMPORTED)
  ENDIF()

  IF(TPL_LIBRARY)
    SET_TARGET_PROPERTIES(Kokkos::${NAME} PROPERTIES
...
MACRO(kokkos_find_imported NAME)
  ...
  FOREACH(LIB ${TPL_LIBRARIES})
    IF(TPL_LIBRARY_PATHS)
      FIND_LIBRARY(LIBRARY_FIND_TEMP ${LIB} PATHS ${TPL_LIBRARY_PATHS})
    ELSE()
      FIND_LIBRARY(LIBRARY_FIND_TEMP ${LIB} PATHS ${${NAME}_ROOT}/lib ${KOKKOS_${NAME}_DIR}/lib)
    ENDIF()
    IF(LIBRARY_FIND_TEMP)
      LIST(APPEND ${NAME}_LIBRARIES ${LIBRARY_FIND_TEMP})
    ENDIF()
  ENDFOREACH()

  INCLUDE(FindPackageHandleStandardArgs)
  IF (TPL_LIBRARY)
    FIND_PACKAGE_HANDLE_STANDARD_ARGS(TPL_${NAME}_LIBRARY DEFAULT_MSG ${NAME}_LIBRARY)
  ENDIF()
  IF(TPL_HEADER)
    FIND_PACKAGE_HANDLE_STANDARD_ARGS(TPL_${NAME}_INCLUDE_DIRS DEFAULT_MSG ${NAME}_INCLUDE_DIRS)
  ENDIF()
  IF(TPL_LIBRARIES)
    FIND_PACKAGE_HANDLE_STANDARD_ARGS(TPL_${NAME}_LIBRARIES DEFAULT_MSG ${NAME}_LIBRARIES)
  ENDIF()
